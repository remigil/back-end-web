...
exports.emailSendPass = (req, res, next, { email = null, code = "" }) =>
  {
    try {
      return new Promise((resolve, reject) => {
        ...
        var mailOptions = {
          ...
          to: email,
          subject: "[LUPA KATA SANDI] Akun Aplikasi Bogor Ngawas",
          html: `<center><h4>Verifikasi Kode OTP Lupa Sandi Akun Aplikasi Bogor Ngawas</h4></center>
